...
custom_local_manifest = ".repo/local_manifests/hyperparanonid.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'xq')
custom_dependencies = "pa.dependencies"
org_manifest = "HyperParanoid-Devices"  # leave empty if org is provided in manifest
org_display = "HyperParanoid-Devices"  # needed for displaying
